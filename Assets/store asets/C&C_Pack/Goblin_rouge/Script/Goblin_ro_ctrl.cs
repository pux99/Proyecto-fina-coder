...
public class Goblin_ro_ctrl : MonoBehaviour {
	...
	void Update () 
	{
		...
		if (Input.GetKeyDown(KeyCode.M)) //defence_start
		{
		...
		if (Input.GetKeyDown(KeyCode.P)) // defence_start
		{
			anim.SetInteger("moving", 8);
		}
		if (Input.GetKeyUp(KeyCode.P)) // defence_end
		{
		...
		if (Input.GetKeyDown(KeyCode.O)) //die_1
		{
			anim.SetInteger("moving", 12);
		}
		if (Input.GetKeyDown(KeyCode.I)) //die_2
		{
			anim.SetInteger("moving", 13);
		}
		
		if (Input.GetKeyDown(KeyCode.U)) //defence
		{
